...
#define SWIGTYPE_p_FakeH264VideoEncoderWorkerFacade swig_types[0]
#define SWIGTYPE_p_MediaFrameListener swig_types[1]
#define SWIGTYPE_p_MediaFrameListenerBridge swig_types[2]
#define SWIGTYPE_p_MedoozeFakeH264EncoderModule swig_types[3]
...
static SwigV8ReturnValue _wrap_new_MediaFrameListenerBridge(const SwigV8Arguments &args) {
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "new_MediaFrameListenerBridge" "', argument " "2"" of type '" "bool""'");
  } 
...
static SwigV8ReturnValue _wrap_FakeH264VideoEncoderWorkerFacade_AddListener(const SwigV8Arguments &args) {
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "FakeH264VideoEncoderWorkerFacade_AddListener" "', argument " "2"" of type '" "MediaFrameListener *""'"); 
  }
...
static SwigV8ReturnValue _wrap_FakeH264VideoEncoderWorkerFacade_RemoveListener(const SwigV8Arguments &args) {
  ...
  res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_MediaFrameListener, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "FakeH264VideoEncoderWorkerFacade_RemoveListener" "', argument " "2"" of type '" "MediaFrameListener *""'"); 
  }
  arg2 = reinterpret_cast< MediaFrameListener * >(argp2);
...
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031710)
static void _wrap_delete_FakeH264VideoEncoderWorkerFacade(v8::Persistent<v8::Value> object, void *parameter) {
  SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031900)
  static void _wrap_delete_FakeH264VideoEncoderWorkerFacade(v8::Isolate *isolate, v8::Persistent<v8::Value> object, void *parameter) {
    SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < SWIGV8_SETWEAK_VERSION)
    static void _wrap_delete_FakeH264VideoEncoderWorkerFacade(v8::Isolate *isolate, v8::Persistent< v8::Object> *object, SWIGV8_Proxy *proxy) {
#elif (V8_MAJOR_VERSION-0) < 5
      static void _wrap_delete_FakeH264VideoEncoderWorkerFacade(const v8::WeakCallbackData<v8::Object, SWIGV8_Proxy> &data) {
        v8::Local<v8::Object> object = data.GetValue();
        SWIGV8_Proxy *proxy = data.GetParameter();
#else
...
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031710)
static void _wrap_delete_MedoozeFakeH264EncoderModule(v8::Persistent<v8::Value> object, void *parameter) {
  SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031900)
  static void _wrap_delete_MedoozeFakeH264EncoderModule(v8::Isolate *isolate, v8::Persistent<v8::Value> object, void *parameter) {
    SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < SWIGV8_SETWEAK_VERSION)
    static void _wrap_delete_MedoozeFakeH264EncoderModule(v8::Isolate *isolate, v8::Persistent< v8::Object> *object, SWIGV8_Proxy *proxy) {
#elif (V8_MAJOR_VERSION-0) < 5
      static void _wrap_delete_MedoozeFakeH264EncoderModule(const v8::WeakCallbackData<v8::Object, SWIGV8_Proxy> &data) {
        v8::Local<v8::Object> object = data.GetValue();
        SWIGV8_Proxy *proxy = data.GetParameter();
#else
...
{
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
  _exports_FakeH264VideoEncoderWorkerFacade_class->Inherit(static_cast<SWIGV8_ClientData *>(SWIGTYPE_p_RTPReceiver->clientdata)->class_templ);
#else
...
v8::Handle<v8::Object> _exports_FakeH264VideoEncoderWorkerFacade_obj = _exports_FakeH264VideoEncoderWorkerFacade_class_0->GetFunction();
#elif (SWIG_V8_VERSION < 0x0704)
_exports_FakeH264VideoEncoderWorkerFacade_class_0->SetHiddenPrototype(true);
...
#else
v8::Local<v8::Object> _exports_FakeH264VideoEncoderWorkerFacade_obj = _exports_FakeH264VideoEncoderWorkerFacade_class_0->GetFunction(SWIGV8_CURRENT_CONTEXT()).ToLocalChecked();
#endif
...
v8::Handle<v8::Object> _exports_MedoozeFakeH264EncoderModule_obj = _exports_MedoozeFakeH264EncoderModule_class_0->GetFunction();
#elif (SWIG_V8_VERSION < 0x0704)
_exports_MedoozeFakeH264EncoderModule_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_MedoozeFakeH264EncoderModule_obj = _exports_MedoozeFakeH264EncoderModule_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_MedoozeFakeH264EncoderModule_obj = _exports_MedoozeFakeH264EncoderModule_class_0->GetFunction(SWIGV8_CURRENT_CONTEXT()).ToLocalChecked();
#endif


  /* add static class functions and variables */
  SWIGV8_AddStaticFunction(_exports_MedoozeFakeH264EncoderModule_obj, "EnableLog", _wrap_MedoozeFakeH264EncoderModule_EnableLog);
SWIGV8_AddStaticFunction(_exports_MedoozeFakeH264EncoderModule_obj, "EnableDebug", _wrap_MedoozeFakeH264EncoderModule_EnableDebug);
SWIGV8_AddStaticFunction(_exports_MedoozeFakeH264EncoderModule_obj, "EnableUltraDebug", _wrap_MedoozeFakeH264EncoderModule_EnableUltraDebug);
...
#endif
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
exports_obj->Set(SWIGV8_SYMBOL_NEW("FakeH264VideoEncoderWorkerFacade"), _exports_FakeH264VideoEncoderWorkerFacade_obj);
#else
SWIGV8_MAYBE_CHECK(exports_obj->Set(SWIGV8_CURRENT_CONTEXT(), SWIGV8_SYMBOL_NEW("FakeH264VideoEncoderWorkerFacade"), _exports_FakeH264VideoEncoderWorkerFacade_obj));
#endif
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
exports_obj->Set(SWIGV8_SYMBOL_NEW("MedoozeFakeH264EncoderModule"), _exports_MedoozeFakeH264EncoderModule_obj);
#else
SWIGV8_MAYBE_CHECK(exports_obj->Set(SWIGV8_CURRENT_CONTEXT(), SWIGV8_SYMBOL_NEW("MedoozeFakeH264EncoderModule"), _exports_MedoozeFakeH264EncoderModule_obj));
#endif
